...
export const AID_STATIONS_KM = [
  ...
  { name: "Tyler's (Lap 1 done)", km: 3.54, target: '7:16 AM', early: '7:12 AM', late: '7:20 AM', cutoff: '—', crewAccess: true },
  ...
  { name: "Tyler's (Lap 2 done)", km: 35.73, target: '9:55 AM', early: '9:35 AM', late: '10:30 AM', cutoff: '—', crewAccess: true },
  ...
  { name: "Tyler's (Lap 3 done)", km: 67.9, target: '1:45 PM', early: '1:00 PM', late: '2:30 PM', cutoff: '7:36 AM*', crewAccess: true },
...
/**
 * Demo runner: Aaron with 2 splits in (mid-race).
 * Split 1: 12.71 km at 9:15 AM, Split 2: 35.41 km at 10:42 AM.
 */
export const DEMO_RUNNER = {
  name: 'Aaron Benson',
  bib: 'TBD',
  splits: [
    { splitId: 'split1', km: 12.71, clockTime: '9:15 AM' },
    { splitId: 'split2', km: 35.41, clockTime: '10:42 AM' },
  ],
};
